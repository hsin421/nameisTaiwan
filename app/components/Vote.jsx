  ...
  render() {
    return (
      <div className={styles.vote}>
        ...
        <br />
        <br />
        本網站設置的目的，是提供海外台人一個通報的平台，來通報並改善這個狀況，集結群眾的力量來為台灣正名
        <br />
        我們在收到通報之後，經過查證若屬實，將以北美FAPA(Formosa Association for Public Affairs)名義向該機關提出正名要求，並追蹤該機構是否回應我們的訴求．這些年北美FAPA致力於正名活動，已成功向許多官方及民間機構提出訴求並成功正名，其中包含：移民署，FDA，Apple…等等．
        <br />
        <a href="http://www.ucarecdn.com/08b8e6bd-f02c-463a-9e0f-2f8efc937216/getPart.jpg" target="_blank" ><img style={{width: '10%', marginLeft: '45%', marginTop: '10px'}} src="http://www.ucarecdn.com/08b8e6bd-f02c-463a-9e0f-2f8efc937216/getPart.jpg" /></a>
        <br />
